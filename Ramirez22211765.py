...
#Funcion de trnasferencia: Normotenso
...
fg1 = plt.figure()
plt.plot(t,Pp0,'-',linewidth=1, color= np.array([127,76,165])/255, label = 'Pp(t): Normotenso')
plt.plot(t,Pp1,'-',linewidth=1, color= np.array([5,127,109])/255, label = 'Pp(t): Hipotenso')
plt.plot(t,Pp2,'-',linewidth=1, color=np.array([223,57,105])/255, label = 'Pp(t): Hipertenso')
...
fg2 = plt.figure()
plt.plot(t,Pp0,'-',linewidth=1, color= np.array([127,76,165])/255, label = 'Pp(t): Normotenso')
plt.plot(t,Pp3,':',linewidth=3, color= np.array([5,127,109])/255, label = 'Pp(t): Hipotenso PI')
plt.plot(t,Pp2,'-',linewidth=1, color= np.array([223,57,105])/255, label = 'Pp(t): Hipertenso')
...
plt.plot(t,Pp0,'-',linewidth=1, color= np.array([127,76,165])/255, label = 'Pp(t): Normotenso')
plt.plot(t,Pp1,'-',linewidth=1, color= np.array([5,127,109])/255, label = 'Pp(t): Hipotenso')
plt.plot(t,Pp4,':',linewidth=3, color=np.array([223,57,105])/255, label = 'Pp(t): Hipertenso PI')
